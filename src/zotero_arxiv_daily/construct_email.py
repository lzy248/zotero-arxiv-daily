...
<title>Daily Papers · 每日论文精选</title></head>
<body style="margin:0;padding:0;background-color:#f3f5f7;color:#263548;font-family:Arial,'Microsoft YaHei',sans-serif;">
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color:#f3f5f7;">
<tr><td align="center" style="padding:28px 12px;">
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:720px;">
<tr><td style="padding:24px;background-color:#152e42;border-radius:12px 12px 0 0;">
...
style="background-color:#ffffff;border:1px solid #dfe6ed;border-radius:12px;margin-bottom:20px;">
<tr><td style="padding:24px;">
<p style="margin:0 0 12px;color:#157a80;font-size:12px;letter-spacing:1px;">{number} {recommendation}</p>
<h2 style="margin:0 0 12px;font-size:21px;line-height:1.45;color:#152e42;overflow-wrap:anywhere;">{title}</h2>
...
def render_email(papers: list[Paper], collapsible=False) -> str:
    parts = []
    ...
    return (framework.replace('__CONTENT__', ''.join(parts) or get_empty_html())
